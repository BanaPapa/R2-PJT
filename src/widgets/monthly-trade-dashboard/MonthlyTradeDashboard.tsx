...
// 각 지표 설명(엑셀 원본 시트 정의 + 100 기준 해석) — 주간 거래지표와 동일.
...
// 월간 거래지표 대시보드 — 주간 TradeDashboard와 동일한 UI·방식.
// 차이는 데이터 소스(월간 시계열)뿐이며, 날짜축이 YYYY-MM인 점만 다르다.
export const MonthlyTradeDashboard: React.FC = () => {
  const {
    tradeData,
    tradeLoading,
    selectedRegions,
